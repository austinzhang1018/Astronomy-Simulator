...
public class GridDisplay extends JComponent implements KeyListener, MouseListener
{
  ...
  public void paintComponent(Graphics g)
  {
    for (int row = 0; row < getNumRows(); row++)
    {
      for (int col = 0; col < getNumCols(); col++)
      {
        ...
        Cell cell = cells[(int)loc.getX()][(int)loc.getY()];
  ...
  public void setColor(Location loc, Color color)
  {
    ...
    cells[(int)loc.getX()][(int)loc.getY()].setColor(color);
    repaint();
  }
  ...
  public Color getColor(Location loc)
  {
    ...
    return cells[(int)loc.getX()][(int)loc.getY()].getColor();
  }
  ...
  public void setImage(Location loc, String imageFileName)
  {
    ...
    cells[(int)loc.getX()][(int)loc.getY()].setImageFileName(imageFileName);
    repaint();
  }
  ...
  public String getImage(Location loc)
  {
    ...
    return cells[(int)loc.getX()][(int)loc.getY()].getImageFileName();
  }
